...
HUB_SKILLS = {
    "github_integration": SkillMetadata(
        ...
        agents=["FORGE", "GHOST"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/github_integration.py",
    ),
    "gitlab_integration": SkillMetadata(
        ...
        agents=["FORGE"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/gitlab_integration.py",
    ),
    "database_query": SkillMetadata(
        ...
        agents=["FORGE", "LENS"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/database_query.py",
    ),
    "api_testing": SkillMetadata(
        ...
        agents=["FORGE", "SCOUT"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/api_testing.py",
    ),
    "sentiment_analysis": SkillMetadata(
        ...
        agents=["LENS", "HERALD"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/sentiment_analysis.py",
    ),
    "translation": SkillMetadata(
        ...
        agents=["HERALD"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/translation.py",
    ),
    "diagram_gen": SkillMetadata(
        ...
        agents=["HERALD", "FORGE"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/diagram_gen.py",
    ),
    "project_planning": SkillMetadata(
        ...
        agents=["NEXUS-0", "LENS"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/project_planning.py",
    ),
    "image_analysis": SkillMetadata(
        ...
        agents=["LENS"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/image_analysis.py",
    ),
    "system_monitoring": SkillMetadata(
        ...
        agents=["GHOST"],
        source="hub",
        hub_url="https://raw.githubusercontent.com/TitoPrausee/nexus-skills/main/skills/system_monitoring.py",
    ),
}
